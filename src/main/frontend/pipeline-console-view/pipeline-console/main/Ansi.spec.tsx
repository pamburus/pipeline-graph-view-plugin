...
import { makeReactChildren, parseEscapeCode, Result,tokenizeANSIString } from "./Ansi.tsx";
...
describe("ANSI Escape Code Parsing", () => {
  ...
  describe("tokenizeANSIString", () => {
    ...
    it("should handle 256-color and true color codes", () => {
      const input = "\u001b[38;5;196mRed256\u001b[38;2;255;128;64mTrueColor\u001b[0m";
      const result = tokenizeANSIString(input);
  ...
  describe("makeReactChildren", () => {
    it("should create div elements for plain text without styling", () => {
      ...
      expect(result[0].props.dangerouslySetInnerHTML.__html).toBe("Hello, world!");
    });
    ...
    it("should reset styles properly", () => {
      ...
      expect(result[1].props.dangerouslySetInnerHTML.__html).toBe("Normal text");
    });
  ...
  describe("Integration Tests", () => {
    it("should handle complex ANSI string with multiple color modes", () => {
      const input = "Normal \u001b[31mRed \u001b[38;5;196m256-Red \u001b[38;2;255;128;64mTrue-Red\u001b[0m Normal";
    ...
    it("should handle nested styling changes", () => {
      const input = "\u001b[31m\u001b[48;5;21mRed on Blue256\u001b[38;2;255;255;255m White on Blue256\u001b[0m";
      const tokens = tokenizeANSIString(input);
