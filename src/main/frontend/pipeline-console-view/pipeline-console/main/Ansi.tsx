...
export function makeReactChildren(
  ...
  for (let i = 0; i < tokenizedInput.length; i++) {
    ...
    if (typeof codeOrString === "string") {
      ...
      if (!currentState.setFG && !currentState.setBG && !currentState.setBold && !currentState.setFaint && !currentState.setItalic && !currentState.setUnderline && !currentState.setStrikeThrough) {
        result.push(
          <div
